...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API Get the build version of card service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<String> geJavaVersion() {
    ...
    public ResponseEntity<CardsContactInfo> geJContactInfo() {
